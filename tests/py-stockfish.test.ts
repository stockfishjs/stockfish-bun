...
describe("Stockfish", () => {
  it("constructor defaults", async () => {
    ...
    expect(stockfish._parameters).toEqual(stockfish._DEFAULT_STOCKFISH_PARAMS);
  ...
  it("test_get_best_move_checkmate", async () => {
